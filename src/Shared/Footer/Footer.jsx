    ...
    return (
        ...
        <footer className="footer p-10 bg-slate-400 text-base-content">
            ...
            <div>
                ...
                <p>Raerbga, Dhaka, Bangladesh</p>
                <span className="footer-title mt-4 text-xl">Contact</span>
                <p>+088-01675237892</p>
            </div>
        </footer>
            <footer className="footer px-10 py-4 border-t bg-black text-white border-base-300">
                <div className="items-center grid-flow-col">
                    <img className='h-20' src="https://www.clipartmax.com/png/full/179-1792539_culture-clipart-service-learning-logo-for-social-science.png" alt="" />
                    <h2 className='text-4xl font-bold my-auto ml-2'>Brainly</h2>
                </div>
                <div className='mt-16'>
